...
from pocket_coffea.lib.cut_functions import get_nObj_min, get_HLTsel, get_nPVgood, goldenJson, get_HLTsel_custom,eventFlags, get_nElectron, get_nMuon, get_nObj_eq, count_objects_eq, apply_golden_json
...
#                   f"{localdir}/datasets/TbarWplus/TbarWplustoLNu2Q_TuneCP5Down_13p6TeV_powheg-pythia8_redirector.json",
    ...
    categories= {
      ...
      #  "Fakes_loose_ele" : [FakeLoose,  get_nObj_eq(1, coll="ElectronLoose")],
        "Fakes_loose_muon" : [get_nObj_eq(0, coll="MuonGood"), get_nObj_eq(1, coll="MuonLoose")],
        "Fakes_tight_muon" : [get_nObj_eq(1, coll="MuonGood"), get_nObj_eq(1, coll="MuonLoose")],
    ...
    weights = {
        "common": { "inclusive": ["genWeight","lumi","XS", "pileup","sf_mu_id", "sf_mu_iso",  "sf_btag"],
            "bycategory" : {
            }
        },
    },
    ...
    workflow_options = {
        "dump_columns_as_arrays_per_chunk": "root://eosuser.cern.ch//eos/user/l/ldellape/VBS/parquet_forfake_test/"
    },
    columns = {
        "common" : {
            "inclusive" : [
                           ...
                           ColOut("PuppiMET", ["pt"], flatten=False),
                           ColOut("PuppiMET", ["pt"], flatten=False),
                           ColOut("events", ["MT_lep_miss", "MT_lepLoose_miss", "deltaR_jetMuonLoose", "deltaR_jetMuonTight"], flatten=False),
                           ],
            "bycategory" : {},
            },            
    },   
    variables = {
        "ElectronGood_pt"  : HistConf([Axis(coll="ElectronGood", field="pt",  bins=50, start=0, stop=500, label="Electron pT")]),
        "ElectronGood_eta" : HistConf([Axis(coll="ElectronGood", field="eta", bins=50, start=-5, stop=5, label="Electron η")]),
        "ElectronGood_phi" : HistConf([Axis(coll="ElectronGood", field="phi", bins=64, start=-3.2, stop=3.2, label="Electron φ")]),
        "MuonGood_pt"  : HistConf([Axis(coll="MuonGood", field="pt",  bins=50, start=0, stop=500, label="Muon pT")]),
        "MuonGood_eta" : HistConf([Axis(coll="MuonGood", field="eta", bins=50, start=-5, stop=5, label="Muon η")]),
        "MuonGood_phi" : HistConf([Axis(coll="MuonGood", field="phi", bins=64, start=-3.2, stop=3.2, label="Muon φ")]),
        "ElectronLoose_pt"  : HistConf([Axis(coll="ElectronLoose", field="pt",  bins=50, start=0, stop=500, label="Muon pT")]),
        "ElectronLoose_eta" : HistConf([Axis(coll="ElectronLoose", field="eta", bins=50, start=-5, stop=5, label="Muon η")]),
        "ElectronLoose_phi" : HistConf([Axis(coll="ElectronLoose", field="phi", bins=64, start=-3.2, stop=3.2, label="Muon φ")]),
        "MuonLoose_pt"  : HistConf([Axis(coll="MuonLoose", field="pt",  bins=50, start=0, stop=500, label="Muon pT")]),
        "MuonLoose_eta" : HistConf([Axis(coll="MuonLoose", field="eta", bins=50, start=-5, stop=5, label="Muon η")]),
        "MuonLoose_phi" : HistConf([Axis(coll="MuonLoose", field="phi", bins=64, start=-3.2, stop=3.2, label="Muon φ")]),
        "LeptonGood_pt"  : HistConf([Axis(coll="LeptonGood", field="pt",  bins=50, start=0, stop=500, label="Lepton pT")]),
        "LeptonGood_eta" : HistConf([Axis(coll="LeptonGood", field="eta", bins=50, start=-5, stop=5, label="Lepton η")]),
        "LeptonGood_phi" : HistConf([Axis(coll="LeptonGood", field="phi", bins=64, start=-3.2, stop=3.2, label="Lepton φ")]),
        "CleanFatJet_pt"        : HistConf([Axis(coll="CleanFatJet", field="pt", bins=60, start=0, stop=1200, label="FatJet pT")]),
        "CleanFatJet_eta"       : HistConf([Axis(coll="CleanFatJet", field="eta", bins=50, start=-5, stop=5, label="FatJet η")]),
        "CleanFatJet_phi"       : HistConf([Axis(coll="CleanFatJet", field="phi", bins=64, start=-3.2, stop=3.2, label="FatJet φ")]),
        "CleanFatJet_tau1"      : HistConf([Axis(coll="CleanFatJet", field="tau1", bins=50, start=0, stop=1, label="τ₁")]),
        "CleanFatJet_tau2"      : HistConf([Axis(coll="CleanFatJet", field="tau2", bins=50, start=0, stop=1, label="τ₂")]),
        "CleanFatJet_tau21"     : HistConf([Axis(coll="CleanFatJet", field="tau21", bins=50, start=0, stop=1, label="τ₂₁")]),
        "CleanFatJet_msoftdrop" : HistConf([Axis(coll="CleanFatJet", field="msoftdrop", bins=60, start=0, stop=300, label="SoftDrop Mass")]),
        "CleanFatJet_mass"      : HistConf([Axis(coll="CleanFatJet", field="mass", bins=60, start=0, stop=300, label="FatJet Mass")]),
    },
)
