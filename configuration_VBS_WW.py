...
cfg = Configurator(
    ...
    variables = {
        ...
        "CleanFatJet_pt"        : HistConf([Axis(coll="CleanFatJet", field="pt", bins=30, start=0, stop=1200, label="FatJet pT")]),
        "CleanFatJet_eta"       : HistConf([Axis(coll="CleanFatJet", field="eta", bins=30, start=-5, stop=5, label="FatJet η")]),
